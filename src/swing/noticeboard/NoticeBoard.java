...
public class NoticeBoard extends javax.swing.JPanel {
    ...
    public NoticeBoard() {
        ...
        // nogrid: không sử dụng lưới để định vị các thành phần.
        // chỉ định vị các thành phần bằng cách sử dụng các ràng buộc như "wrap",
        // "newline", "alignx center", "aligny top", và các ràng buộc khác.
    }
