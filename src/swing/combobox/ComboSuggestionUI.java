...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    @Override
    public void installUI(JComponent jc) { // được gọi khi UI của JComboBox được cài đặt
        super.installUI(jc);
        Border border = new Border();
        JTextField txt = (JTextField) comboBox.getEditor().getEditorComponent(); // gọi JTextField trong JComboBox.
        // Sự kiện lắng nghe focus vào và ra khỏi JTextField để thay đổi màu viền.
...
//        sự kiện lắng nghe sự kiện mở popup menu để thay đổi màu nền của nút mở dropdown
 ...
 // AutoCompleteDecorator.decorate(comboBox) tự động hoàn thành cho Jcombobox (tức là khi nhập một phần của từ khóa và 
 // tự động hoàn thành từ khóa dựa trên các mục có sẵn trong danh sách của JComboBox)
        AutoCompleteDecorator.decorate(comboBox);
        txt.setSelectionColor(new Color(54, 189, 248)); // set màu nền của chữ khi đc tô đen lên
    ...
    private class ComboSuggestionPopup extends BasicComboPopup {
        ...
        protected JScrollPane createScroller() {
            ...
            sb.setPreferredSize(new Dimension(5, 50));
