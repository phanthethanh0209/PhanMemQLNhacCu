...
public class Message extends javax.swing.JDialog {
    ...
    public static boolean showMessageSuccess(String message) {
    ...
    public static boolean showMessageError(String message) {
        Message obj = new Message(Main.getFrames()[0], true, GoogleMaterialDesignIcons.REPORT_PROBLEM);
        obj.showMessage(message);
        return obj.isOk();
    }
    ...
    private void initComponents() {
        ...
        button1.setBackground(new java.awt.Color(123, 110, 255));
