...
public class MessageQuestion extends javax.swing.JDialog {
    ...
    public MessageQuestion(java.awt.Frame parent, boolean modal, GoogleMaterialDesignIcons icon) {
        super(parent, modal);
        initComponents();
    ...
    public boolean showMessageSuccess(String message) {
    ...
    private void initComponents() {
        ...
        btnNo.setBackground(new java.awt.Color(123, 110, 255));
        ...
        btnYes.setBackground(new java.awt.Color(123, 110, 255));
...
//    }
    ...
    private swing.Button btnNo;
    private swing.Button btnYes;
